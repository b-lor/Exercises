...
namespace Classes_Functions_and_Regions
{
    /// <summary>
    /// Asks the user to guess a number between a certain range and then guesses that number in the fewest possbile guesses
    /// </summary>
    public class NumberGuesser
    {
        ...
        /// <summary>
        /// The current know maximum number the user is thinking of
        /// </summary>
        ...
        /// <summary>
        /// Asks a user to think of a number between 0 and the maximum number
        /// </summary>
        ...
        {
            // Clear variables to their inital values before discovery
